...
api.interceptors.request.use(
  async (config) => {
    // Use hardcoded token for all API calls (working token)
    const hardcodedToken = 'NlBQeitBNGhjT0h0VGd2ODdSQS9SNWF5VVpTM2FCd3lRdHVkcW1aZXVQWDVEcTJPNExobkI3TFFTWWRIbVVLbkhrbjNvZE1FVnFpeHRPdDFmZmxGdDFiV2RJbnpKeW13T2RHQXRQOG5XTGJzREVxMjZTMW85OVRWMGhjeGpsNjZOa0pjRUsvWFlYMndHQjFnekpwUkFGZDBUekpGQ1F6YmcwcFpzK0J1eVRjPQ==';
    config.headers['proxy_auth_token'] = hardcodedToken;
    return config;
  },
  (error) => {
